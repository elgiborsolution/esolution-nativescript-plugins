...
export class MultiSelect {
  ...
  public show(options: MSOption): void {
    ...
    const MSSelect = new com.abdeveloper.library.MultiSelectDialog()
      ...
      .onSubmit(
        new com.abdeveloper.library.MultiSelectDialog.SubmitCallbackListener({
    ...
    // Show
    (MSSelect as any).show(application.android.foregroundActivity.getSupportFragmentManager(), 'multiSelectDialog');
  }
