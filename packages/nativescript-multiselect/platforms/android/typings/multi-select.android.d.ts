    ...
    export namespace library {
      ...
      export namespace MultiSelectDialog {
        export class SubmitCallbackListener {
           ...
           */
          public constructor(implementation: { onSelected(param0: java.util.ArrayList<java.lang.Integer>, param1: java.util.ArrayList<string>, param2: string): void; onCancel(): void; onItemSelected(param0: java.lang.Integer, param1: string): void });
          public constructor();
